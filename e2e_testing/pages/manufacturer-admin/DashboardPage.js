...
class DashboardPage extends BasePage {
  constructor(page) {
    ...
    this.selectors = {
      // Navigation
      productInsightsTab: '.logo-and-menus a[href="/app/dashboard"]',
      // Page Title
      pageTitle: 'text="Dashboard"',
      // Filters
      distributorFilter: '#custom-dropdown label:has-text("All Distributors")',
      distributorOption: (name) => `#custom-dropdown text=${name}`,
  ...
  //   await this.page.locator(this.selectors.distributorFilter).click();
  //   await this.page.locator(this.selectors.distributorOption(name)).click();
  //   await this.page.waitForLoadState('networkidle');
  // }
