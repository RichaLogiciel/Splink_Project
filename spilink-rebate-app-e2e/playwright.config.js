...
module.exports = defineConfig({
  ...
  testMatch: [
    ...
    'tests/distributor-admin/store-spiff-breakdown-common.spec.ts',
    ...
    'tests/sales-rep-manager/store-spiff-breakdown-common.spec.ts',
    ...
    'tests/sales-rep/store-spiff-breakdown-common.spec.ts',
