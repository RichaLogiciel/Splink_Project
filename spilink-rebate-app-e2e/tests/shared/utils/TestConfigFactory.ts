...
import StoreSpiffDetailPage from '../../../pages/shared/StoreSpiffDetailPage';
import StoreSpiffPage from '../../../pages/shared/StoreSpiffPage';
  ...
  static createSalesRepConfig(userKey: string): TestConfig {
    ...
    return {
      ...
      pageClasses: {
        ...
        storeSpiffPage: StoreSpiffPage,
        storeSpiffDetailPage: StoreSpiffDetailPage,
      },
      navigationConfig: {
