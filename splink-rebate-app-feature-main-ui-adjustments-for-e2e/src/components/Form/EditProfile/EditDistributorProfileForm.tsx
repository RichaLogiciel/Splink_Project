...
import { isDistributorAdmin, isStore } from "@/utils/rolesConditions";
...
const EditDistributorProfile: React.FC<EditProfilePropType> = ({
  userInfo
}) => {
  ...
  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    ...
    const formData = {
      ...
      ...(data?.distributorName && { distributorName: data.distributorName })
    };
    ...
    try {
      ...
      updateUserCookieClient({
        ...
        logo: logoUrl,
        ...(data?.distributorName && { orgName: data.distributorName })
      });
      ...
      <div className="rounded-lg bg-white p-7 sm:p-14 shadow-xl">
        <div className="max-w-[720px] mx-auto">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-10">
            ...
            {user && (isDistributorAdmin(user.role) || isStore(user.role)) && (
              <>
            ...
            <div className="flex space-x-4 ">
              {isStore(user?.role || "") && (
                <div className="flex-1">
                  <label htmlFor="storeName" className="mb-2 block text-xs">
                    Store Name<span className="text-[#FF1010]">*</span>
                  </label>
                  <input
                  ...
                  {logo && logo.url ? (
                    ...
                    <>
                      ...
                      <div className="text-xs text-gray-500 mt-1">
                        Supported Formats: png, jpg & jpeg. Max allowed file
                        size: 2MB
                      </div>
                    </>
                  )}
