...
import SalesManagerProgramDetailsModal from "../Dialog/SalesManagerProgramDetailsModal";

const SalesManagerProgramTable: React.FC<SalesRepProgramTableType> = ({
  programs,
  id
}) => {
  ...
  return (
    <>
      <div
        className="SalesManagerProgram text-left text-filter-light font-normal font-inter mt-2"
        id={id}
      >
        {windowWidth > 640 ? (
            ...
            <table className="w-full border-collapse">
              <thead className="h-11 border-b text-heading-very-light text-xs">
                <tr>
                  ...
                  <th className="font-normal min-w-64 px-2 sm:px-4">
                    Overview
                  </th>
                  ...
                  programs.map((program, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-2 sm:px-4 py-3">
                          {getNumericDateString(program.startDate ?? "") ?? ""}
                        </td>
                        <td className="px-2 sm:px-4 py-3">
                          {getNumericDateString(program.endDate ?? "")}
                        </td>
                      </tr>
                    );
                  })
              ...
              programs.map((program, index) => {
                ...
                return (
                  <div
                    ...
                    className="shadow rounded-lg py-3 px-4 bg-white mb-3 cursor-pointer hover:bg-gray-50 transition-colors"
                    onClick={() => handleProgramClick(program)}
                  >
      ...
      {/* Sales Manager Program Details Modal */}
      <SalesManagerProgramDetailsModal
        isOpen={isModalOpen}
...
export default SalesManagerProgramTable;
