...
export const fetchManufacturerKeyMetrics = async (
  ...
  try {
    ...
    let url = `/manufacturer/key-metrics-optimized?distributorId=${distributorIdParam}&selectedProducts=${selectedProductsParam}&monthRange=${monthRange}`;
    if (year) {
      url += `&year=${year}`;
    }
...
export const fetchManufacturerTopProducts = async (
  ...
  try {
    ...
    let url = `/manufacturer/top-products-optimized?distributorId=${distributorIdParam}&selectedProducts=${selectedProductsParam}&monthRange=${monthRange}`;
    if (year) {
      url += `&year=${year}`;
    }
...
export const fetchManufacturerDistributorSales = async (
  ...
  try {
    ...
    let url = `/manufacturer/get-distributor-sales?distributorId=${distributorIdParam}&selectedProducts=${selectedProductsParam}&monthRange=${monthRange}`;
    if (year) {
      url += `&year=${year}`;
    }
...
export const fetchManufacturerStorePenetration = async (
  ...
  try {
    ...
    let url = `/manufacturer/get-store-penetration?distributorId=${distributorIdParam}&selectedProducts=${selectedProductsParam}&monthRange=${monthRange}`;
    if (year) {
      url += `&year=${year}`;
    }
