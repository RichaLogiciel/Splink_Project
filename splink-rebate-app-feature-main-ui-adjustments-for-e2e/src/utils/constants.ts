...
export const ORDERING_FEATURE_EXCLUDED_WAREHOUSE_IDS: number[] = process.env
  .NEXT_PUBLIC_ORDERING_FEATURE_EXCLUDED_WAREHOUSE_IDS
  ? process.env.NEXT_PUBLIC_ORDERING_FEATURE_EXCLUDED_WAREHOUSE_IDS?.trim()
      ?.split(",")
