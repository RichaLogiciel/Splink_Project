...
const ProfileSetup: React.FC<EditProfileProps> = ({
  ...
  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    ...
    try {
      ...
      const params = {
        ...
        state: data.state,
        zip: data.zip,
        orgName: data?.manufacturerName || undefined,
  ...
  return (
    ...
    >
      ...
      {isManufacturerAdmin(role) && (
        <div className="flex space-x-4 mb-5">
          <div className="flex-1">
            <label htmlFor="manufacturerName" className="mb-2 block text-xs">
              Manufacturer Name<span className="text-[#FF1010]">*</span>
            </label>
            <input
